...
CREATE INDEX IF NOT EXISTS idx_notas_disciplina
ON notas(disciplina_id);

CREATE INDEX IF NOT EXISTS idx_faltas_aluno
ON faltas(aluno_id);

CREATE INDEX IF NOT EXISTS idx_faltas_disciplina
ON faltas(disciplina_id);

CREATE INDEX IF NOT EXISTS idx_boletos_aluno
ON boletos(aluno_id);

CREATE INDEX IF NOT EXISTS idx_boletos_status
ON boletos(status);
...
(
    'Administrador',
    'admin@escola.com',
    '$2b$10$ExemploHashAdminAqui1234567890',
    'admin'
)
...
(
    'João Silva',
    'joao@escola.com',
    '$2b$10$ExemploHashAluno1234567890ab',
    'aluno'
),
(
    'Maria Souza',
    'maria@escola.com',
    '$2b$10$ExemploHashAluno1234567890cd',
    'aluno'
),
(
    'Carlos Mendes',
    'carlos@escola.com',
    '$2b$10$ExemploHashAluno1234567890ef',
    'aluno'
)
ON CONFLICT DO NOTHING;

-- Registros de alunos
INSERT INTO alunos (usuario_id, matricula, data_nasc, telefone)
VALUES
...
-- Turma
INSERT INTO turmas (nome, ano, semestre)
VALUES
...
-- Disciplinas
INSERT INTO disciplinas (nome, codigo, carga_hora, turma_id)
VALUES
...
-- Faltas
INSERT INTO faltas (aluno_id, disciplina_id, data_falta, justificada)
VALUES
...
(
    1,
    'Mensalidade Fevereiro/2026',
    850.00,
    '2026-02-10',
    'pago',
    '23790.00000 00000.000000 00000.000000 1 00000000085000'
),
(
    1,
    'Mensalidade Março/2026',
    850.00,
    '2026-03-10',
    'pago',
    '23790.00000 00000.000000 00000.000001 1 00000000085000'
),
(
    1,
    ...
    '2026-04-10',
    'pago',
    '23790.00000 00000.000000 00000.000002 1 00000000085000'
),
(
    1,
    ...
    '2026-05-10',
    'pendente',
    '23790.00000 00000.000000 00000.000003 1 00000000085000'
),
(
    1,
    ...
    '2026-06-10',
    'pendente',
    '23790.00000 00000.000000 00000.000004 1 00000000085000'
)
ON CONFLICT DO NOTHING;
